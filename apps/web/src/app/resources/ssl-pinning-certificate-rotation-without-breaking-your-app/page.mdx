...
<Section bg="gradient" className="pb-4 pt-14">
  <Breadcrumbs
    items={[
      ...
      {
        label: "SSL Pinning Certificate Rotation Without Breaking Your App",
        href: "/resources/ssl-pinning-certificate-rotation-without-breaking-your-app/",
      },
    ]}
  />
</Section>
...
<p className="text-sm text-ink-500">April 8, 2026 · AppShield Team</p>
