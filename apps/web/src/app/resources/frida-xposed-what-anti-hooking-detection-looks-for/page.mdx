...
<Section bg="gradient" className="pb-4 pt-14">
  <Breadcrumbs
    items={[
      ...
      {
        label: "Frida and Xposed: What Anti-Hooking Detection Looks For",
        href: "/resources/frida-xposed-what-anti-hooking-detection-looks-for/",
      },
    ]}
  />
</Section>
...
<p className="text-sm text-ink-500">May 14, 2026 · AppShield Team</p>
