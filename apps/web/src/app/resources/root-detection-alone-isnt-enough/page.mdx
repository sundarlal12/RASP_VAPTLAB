...
<Section bg="gradient" className="pb-4 pt-14">
  <Breadcrumbs
    items={[
      ...
      { label: "Root Detection Alone Isn't Enough Anymore", href: "/resources/root-detection-alone-isnt-enough/" },
    ]}
  />
</Section>
...
<p className="text-sm text-ink-500">June 2, 2026 · AppShield Team</p>
